------------------------------------------------------------------------------
-- xps_npi_dma.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use xps_npi_dma_v3_00_a.user_logic;
...
entity xps_npi_dma is
  ...
  (
    ...
    Capture_data		    	    : in std_logic_vector(0 to 31);
...
end entity xps_npi_dma;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of xps_npi_dma is
  ...
  ------------------------------------------
  constant USER_NUM_INTR                  : integer              := 8;
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity xps_npi_dma_v3_00_a.user_logic
    generic map
    (
