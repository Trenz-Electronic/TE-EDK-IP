------------------------------------------------------------------------------
-- xps_i2c_slave.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          xps_i2c_slave.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Tue Apr 08 20:01:05 2008 (by Create and Import Peripheral Wizard)
...
use xps_i2c_slave_v1_20_a.user_logic;
...
end entity xps_i2c_slave;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of xps_i2c_slave is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity xps_i2c_slave_v1_20_a.user_logic
    generic map
    (
      -- MAP USER GENERICS BELOW THIS LINE ---------------
      --USER generics mapped here
		C_I2C_ADDRESS 	=> C_I2C_ADDRESS, 
		C_MB_INT_BYTES => C_MB_INT_BYTES,
