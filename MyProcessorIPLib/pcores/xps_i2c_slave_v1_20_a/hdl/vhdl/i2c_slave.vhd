...
--   sda <= 'Z' when sda_q='1' else '0';
   ...
   states : block
      type STATE_TYPE is (IDLE, WT_SCL_LO, RD_SLV_ADR, CHECK_STS_FOR_ACK,
                           CHECK_ACK, BRANCH, MSTR_WR, MSTR_RD, WR_ACK, CHECK_STOP);
   ...
   begin
      ...
      begin
         if Reset_n='0' then
            ...
            ld_tx_3_q        <= false;
            busy_q           <= false;
            tx_empty_q       <= '0';   --fho: changed to zero
            sda_q            <= '1';
            slv_ack_q        <= '1';
            rx_buf_ena_q     <= '0';
            rx_vld           <= '0';
            ...
            case state_q is
               ...
               when RD_SLV_ADR =>
                  if stop_cnd_q then
                     ...
                     if slv_adr = conv_integer(unsigned(rx_shiftreg_q(7 downto 1))) then
               ...
               when CHECK_STS_FOR_ACK =>
                  ...
                  if stop_cnd_q then
                     ...
                     state_q <= WT_SCL_LO;
                  elsif -- fho: uncomment this check (rx_shiftreg_q(0)='1' and tx_empty_q = '1') or   -- Master Read
