...
Peripheral Summary:
  ...
  XPS project / EDK repository               : E:\DOKTORAT\Projekti\HSS3\EDK\MyProcessorIPLib
  logical library name                       : xps_i2c_slave_v1_00_a
  top name                                   : xps_i2c_slave
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- ISE project file(s)
  ...
  devl/projnav/xps_i2c_slave.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/xps_i2c_slave_xst.prj
...
- Driver interface file(s)
  ...
  data/xps_i2c_slave_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/xps_i2c_slave_v2_1_0.tcl
