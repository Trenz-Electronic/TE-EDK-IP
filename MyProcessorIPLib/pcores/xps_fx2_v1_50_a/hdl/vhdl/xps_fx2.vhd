...
use xps_fx2_v1_50_a.user_logic;
...
architecture IMP of xps_fx2 is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity xps_fx2_v1_50_a.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "010" => ipif_IP2Bus_Data <= (others => '0');
      when "001" => ipif_IP2Bus_Data <= intr_IP2Bus_Data;
